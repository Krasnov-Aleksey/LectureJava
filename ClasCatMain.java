...
public class ClasCatMain {
    ...
    public static void main(String[] args) {
        Set<ClasCat> set = new HashSet<>();

        ClasCat cat1 = new ClasCat(121, "Васька", "Иван Петрович",8,"черный");
        ClasCat cat2 = new ClasCat(22, "Мурка", "Мария Ивановна",9,"рыжий");
        ClasCat cat3 = new ClasCat(564, "Барсик", "Иван Васильевич",8,"белый");
        ClasCat cat4 = new ClasCat(564, "Барсик", "Иван Васильевич",8,"белый");
...
//        }
        ...
        List<ClasCat> res = new ArrayList<>();
        for (ClasCat cat: set){
            if (cat.age == 8){
                res.add(cat);
            }
